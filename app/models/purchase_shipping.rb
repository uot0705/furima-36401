class PurchaseShipping
  ...
  :address, :building_name, :telephone_number,:token

  #バリデーションの処理を書く
  validates :user_id, :item_id,:postal_code, :prefecture_id, :municipalitie,:address, :telephone_number,:token,presence: true
